...
public class ETSystemGenerator: ISourceGenerator
{
    ...
    /// 根据模板生成System代码
    /// </summary>
    private void GenerateSystemCodeByTemplate(string namespaceName, string className, ClassDeclarationSyntax classDeclarationSyntax, HashSet<MethodDeclarationSyntax> methodDeclarationSyntaxes, GeneratorExecutionContext context, SemanticModel semanticModel)
    {
...
""";
    ...
    class SyntaxContextReceiver: ISyntaxContextReceiver
    {
        ...
        private readonly AttributeTemplate attributeTemplate;
