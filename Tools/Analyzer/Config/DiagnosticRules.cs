...
public static class UniqueIdRangeAnalyzerRule
{
...
public static class CheckETCancelTokenAfterAwaitAnalyzerRule
{
...
public static class DisableNormalClassDeclarationInModelAssemblyAnalyzerRule
{
    ...
    public static readonly DiagnosticDescriptor Rule =
        new DiagnosticDescriptor(DiagnosticIds.DisableNormalClassDeclarationInModelAssemblyAnalyzerRuleId,
            Title,
            MessageFormat,
            DiagnosticCategories.All,
            DiagnosticSeverity.Error,
...
public static class EntityFiledAccessAnalyzerRule
{
    ...
    public static readonly DiagnosticDescriptor Rule = new DiagnosticDescriptor(DiagnosticIds.EntityFiledAccessAnalyzerRuleId,
        Title,
        MessageFormat,
        DiagnosticCategories.Hotfix,
        DiagnosticSeverity.Error, 
...
public static class HotfixProjectFieldDeclarationAnalyzerRule
{
    private const string Title = "实体字段访问错误";
    ...
    public static readonly DiagnosticDescriptor Rule = new DiagnosticDescriptor(DiagnosticIds.HotfixProjectFieldDeclarationAnalyzerRuleId,
        Title,
        MessageFormat,
        DiagnosticCategories.Hotfix,
        DiagnosticSeverity.Error, 
...
public static class ClassDeclarationInHotfixAnalyzerRule
{
    ...
    public static readonly DiagnosticDescriptor Rule = new DiagnosticDescriptor(DiagnosticIds.ClassDeclarationInHotfixAnalyzerRuleId,
        Title,
        MessageFormat,
        DiagnosticCategories.Hotfix,
        DiagnosticSeverity.Error, 
...
public static class EntityMethodDeclarationAnalyzerRule
{
...
public static class StaticClassCircularDependencyAnalyzerRule
{
    ...
    public static readonly DiagnosticDescriptor Rule = new DiagnosticDescriptor(DiagnosticIds.StaticClassCircularDependencyAnalyzerRuleId,
        Title,
        MessageFormat,
        DiagnosticCategories.Hotfix,
        DiagnosticSeverity.Error, 
