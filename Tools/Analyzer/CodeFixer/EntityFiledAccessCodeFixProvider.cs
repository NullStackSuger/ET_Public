...
public class EntityFiledAccessCodeFixProvider: CodeFixProvider
{
    ...
    public sealed override async Task RegisterCodeFixesAsync(CodeFixContext context)
    {
        ...
        diagnostic.Properties.TryGetValue("FriendOfType", out string? friendClassType);
        if (friendClassType==null)
        {
            return;
        }
        ...
        CodeAction action = CodeAction.Create(
            ...
            c => AddFriendOfAttributeAsync(context.Document, classDeclaration,friendClassType, c),
