...
namespace ET
{
    ...
    public class ImGuiController : IDisposable
    {
        ...
        public void CreateDeviceResources(GraphicsDevice gd, OutputDescription outputDescription)
        {
            ...
            byte[] vertexShaderBytes = LoadEmbeddedShaderCode(gd.ResourceFactory, $"Shaders\\ImGui.vert", ShaderStages.Vertex);
            byte[] fragmentShaderBytes = LoadEmbeddedShaderCode(gd.ResourceFactory, $"Shaders\\ImGui.frag", ShaderStages.Fragment);
