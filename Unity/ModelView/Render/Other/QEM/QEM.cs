...
public static class QEM
{
    ...
    public static Mesh Simplify(this Mesh originalMesh, int targetCount)
    {
        ...
        foreach (qem.Triangle t in originalMesh.tris)
        {
        ...
        {
            tris = finalDistinctFaces.Select(x => new qem.Triangle(x.V1.Vector3, x.V2.Vector3, x.V3.Vector3)).ToArray()
        };
