...
public class IdGenerator: Singleton<IdGenerator>, ISingletonAwake
{
    ...
    private int fiberIdValue = 10000000; // 10000000以下为保留的用于StartSceneConfig的fiber id, 1个区配置1000个纤程，可以配置10000个区
    ...
    public int GenerateFiberId()
    {
        return Interlocked.Increment(ref this.fiberIdValue);
    }
}